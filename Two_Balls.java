...
public class App {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            int terms = 8; // default number of Fibonacci terms
            try {
                String input = JOptionPane.showInputDialog("Enter number of Fibonacci terms (>=1):");
                if (input != null) {
                    terms = Integer.parseInt(input.trim());
                    if (terms < 1) throw new NumberFormatException();
                }
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(null, "Invalid input. Using default value: 8");
            }
...
class PhysicsPanel extends JPanel implements java.awt.event.ActionListener, java.awt.event.MouseListener, java.awt.event.MouseMotionListener {
